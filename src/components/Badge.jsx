        ...
        <React.Fragment>
            <div className = "Badge m-5 flex-column">
                ...
                <div className="Badge__userInfo container mt-5 mb-1">
                    ...
                    <h4 className="text-center mt-5"> Brayan Decanini <i>20</i></h4>
                    <p className="text-center"> Camargo City </p>
                </div>
                <div className="Badge__info container pt-3">
                    <div className="row">
                        <div className="col">
                            <h4 className="text-center fw bold">105M</h4>
                            <p className="text-center">Followers</p>
                        </div>
                        <div className="col">
                            <h4 className="text-center fw bold">5M</h4>
                            <p className="text-center">Likes</p>
                        </div>
                        <div className="col">
                            <h4 className="text-center fw bold">500</h4>
